...
class UtmRegistration(Base, TimestampMixin, ModelHelpersMixin, IdPkMixin):
    __tablename__ = "utm_registrations"
    __table_args__ = (
        UniqueConstraint("utm_campaign_id", "user_id", name="uq_utm_regs_utm_campaign_user"),
    )
    ...
    campaign: Mapped["UtmCampaign"] = relationship(back_populates="registrations")
