...
BTN_CUSTOM_PROMPT = "✍️ Свой промпт"
...
ASK_CUSTOM_PROMPT = (
    "✍️ <b>Введите полный промпт</b>\n\n"
    "Опишите всё, что хотите увидеть на видео — "
    "именно этот текст уйдёт в нейросеть целиком.\n"
    "Или нажмите <b>«Пропустить»</b> для стандартного сценария."
)
GENERATION_STARTED = (
...
GENERATION_PROGRESS_NO_PERCENT = "🔄 Нейросеть обрабатывает ваше видео..."
